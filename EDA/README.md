...
2. Importing data to python, data cleaning and preperation
3. Exploratory analysis and visualizations using Matplotlib and Seaborn
4. Ask and answer questions about the data
5. Concluding with collected inferences on the data.


##### DataSet

Zomato Banglore Restaurants dataset is selected from kaggle. Description about the dataset from kaggle.
